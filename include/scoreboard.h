...
public:
    ...
    void draw(Font font, Texture2D hudSheet, int screenWidth, bool showTimeValue = true) const;
    void drawLevelIntro(Font font, Texture2D hudSheet, int screenWidth, int lives) const;
};
